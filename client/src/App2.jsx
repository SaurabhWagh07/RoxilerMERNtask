...
function App2() {
  ...
  return (
    <div className="container-fluid bg-dark text-light fw-bold text-center" style={{ marginTop: "50px" }}>
      <h1 className='text-warning fw-bold'>Sales Dashboard</h1>
      ...
      <button onClick={fetchSalesData} className='btn btn-outline-success fw-bold mx-2'><i class="fa-solid fa-magnifying-glass"></i> Get Sales Data</button>
      ...
      <div className="chart-container mt-5 justify content-center">
        <h1 className="text-warning fw-bold">Sales Data Bar Chart</h1>
